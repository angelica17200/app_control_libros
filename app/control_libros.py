...
-------------------------------------------\n")
    ...
    r.place(x=30,y=195) 
    if libros==[]:
        spintTitulo = Spinbox(ventana, value=(valores), width=70).place(x=110,y=450)
...
sal =Button (ventana, image=imgbtn, command=salir) .place (x=300, y=65)
